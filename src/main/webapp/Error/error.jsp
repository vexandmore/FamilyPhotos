...
<html>
    <head>
        ...
        <title>Error <%= (String)request.getAttribute("jakarta.servlet.error.status_code") %></title>
		<style>
    ...
    <body>
        <h1>Error <%= (String)request.getAttribute("jakarta.servlet.error.status_code") %></h1>
		<hr/>
